...
@Component({
  selector: 'app-import-teis',
  templateUrl: './import-teis.component.html',
  styleUrls: ['./import-teis.component.scss']
})
export class ImportTeisComponent implements OnInit{
  data!: [][]  ;
  dataExcel!: [][]
  ...
  constructor(private formBuilder: FormBuilder,
    private dialogRef: MatDialogRef<ImportTeisComponent>,){}
